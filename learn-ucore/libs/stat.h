...
#define S_IFIFO         060000          // 先进先出(fifo)
#define S_IFSOCK        070000          // socket
...
#define S_ISFIFO(mode)                  (((mode) & S_IFMT) == S_IFIFO)      // fifo file
#define S_ISSOCK(mode)                  (((mode) & S_IFMT) == S_IFSOCK)     // socket file
