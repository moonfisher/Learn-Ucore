...
#define sigset_initwith(set, init)	((set) = (init))
#define sigset_add(set, nsig)	    ((set) |= 1ull << ((nsig) - 1))
#define sigset_del(set, nsig)	    ((set) &= ~(1ull << ((nsig)- 1)))
#define sigset_addmask(set, mask)	((set) |= (uint64_t)(mask))
#define sigset_delmask(set, mask)	((set) &= ~(uint64_t)(mask))
#define sigismember(set, nsig)	    (1 & ((set) >> ((nsig) - 1)))
#define sigmask(nsig)	            (1ull << ((nsig) - 1))
